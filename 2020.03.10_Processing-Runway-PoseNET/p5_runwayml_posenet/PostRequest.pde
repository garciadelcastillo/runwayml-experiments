/*
  Modified HTTP POST request class from https://github.com/runemadsen/HTTP-Requests-for-Processing/blob/master/src/http/requests/PostRequest.java
 - Added the possibility of sending a stringified JSON object.
 
 I should probably pull-request this... :)
 */
...
public class PostRequest
{
  ...
  String jsonRequest;  // JLX addition
  ...
  public void addJSONString(String jsonString) {
    this.jsonRequest = jsonString;   // JLX addition
  }
  ...
  public void send() 
  {
    try {
      ...
      // JLX addition: if there is a "hardcoded" json request, use it over all other content
      if (!jsonRequest.isEmpty()) 
      {
        StringEntity entity = new StringEntity(jsonRequest);
        httpPost.setEntity(entity);
        //httpPost.setHeader("Accept", "application/json");
        //httpPost.setHeader("Content-type", "application/json");  // JLX: should we do this or let the user handle this?
